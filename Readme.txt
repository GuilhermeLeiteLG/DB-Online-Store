...
Este conjunto de comandos SQL serve como uma base sólida para explorar e entender os conceitos fundamentais de bancos de dados MySQL no contexto de uma loja online. Fique à vontade para utilizá-lo e adaptá-lo conforme necessário para seus próprios projetos de estudo!